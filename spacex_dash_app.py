...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        #df = df[["Launch Site", "class"]].groupby(["class"], as_index=False).agg(["count"])
        filtered_df = filtered_df.groupby(["class"])["Launch Site"].count().reset_index(name='counts')
...
@app.callback(Output(component_id='success-payload-scatter-chart', component_property='figure'),
              ...
              Input(component_id='site-dropdown', component_property='value'))
def get_scatter_chart(entered_mass,entered_site):
    min_payload, max_payload = entered_mass
    filtered_df = spacex_df
